...
#V3 deploy will download the csv file from github not from personal computer
# Imports
import pandas as pd
...
github_csv_path = "https://raw.githubusercontent.com/twrighta/southern-water-sewage-dashboard/main/southern_water_spills_2017_2023.csv"

# Read in dataset and process useful columns:
df = pd.read_csv(github_csv_path,
